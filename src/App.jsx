...
const Logo = ({ className, onClick }) => (
    <div onClick={onClick} className={`cursor-pointer ${className}`}>
        <svg viewBox="0 0 130 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-auto">
            <text x="36" y="24" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" fill="#333">Explora</text>
        ...
        <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
                <div className="flex-shrink-0">
                    <Logo className="h-8 w-auto" onClick={onLogoClick} />
                </div>
                <div className="flex-shrink-0">
...
const HomePage = ({ onSelectFeature }) => {
    ...
    return (
        <div className="min-h-[calc(100vh-128px)] flex items-center">
            <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8 w-full">
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">Welcome to Explora</h1>
...
const FeaturePage = ({ feature, onBack }) => {
    ...
    const handleVerify = () => {
        ...
        }, 8000); // Simulate verification time (Increased to 6s)
    };
    ...
    const handleGenerate = () => {
        ...
        }, 2500); // 2.5 seconds per row (Increased)
        
        setTimeout(() => {
            setStep(5);
        }, previewData.length * 2500 + 1000);
    };
    ...
    const handleDownload = () => {
        ...
        switch(feature.title) {
            case "Generate Test Case Scenarios": {
                ...
                filename = `RD011_Procurement_Test_Cases_${timestamp}.csv`;
                mimeType = "text/csv";
                break;
            }
            ...
            case 2: // Verifying
                return (
                    <div className="w-full max-w-2xl text-center animate-fade-in">
                        ...
                        <p className="mt-2 text-gray-600">Explora is analyzing your file to ensure it's ready for processing.</p>
                        <div className="mt-12">
                            <ThinkingAnimation steps={["Reading file...", "Checking format...", "Validating content...", "Verification complete!"]} durationPerStep={3500} />
                        </div>
                    </div>
                );
            ...
            case 4: // Generating
                return (
                    <div className="w-full max-w-6xl text-center animate-fade-in">
                         ...
                         <p className="mt-2 text-gray-600">Explora is now creating the test scenarios based on your document.</p>
                         <div className="mt-8 flex flex-col lg:flex-row items-center justify-center gap-12">
                            <ThinkingAnimation steps={thinkingSteps} durationPerStep={3500} />
                ...
                return (
                    <div className="w-full max-w-6xl text-center animate-fade-in">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
                            <button onClick={handleDownload} className="w-full sm:w-auto bg-teal-500 text-white py-3 px-8 rounded-lg text-lg font-semibold hover:bg-teal-600 transition-colors flex items-center justify-center transform hover:scale-105">
             ...
             <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="mt-6 text-left space-y-4 text-gray-600">
                    ...
                    <div className="flex items-center p-4 bg-white rounded-lg shadow-sm">
                        ...
                        <p className="ml-4">Explora verifies the document's content and structure.</p>
                    </div>
                    <div className="flex items-center p-4 bg-white rounded-lg shadow-sm">
        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <footer className="bg-gray-50">
                <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 text-center text-sm text-gray-400">
                    <p>&copy; {new Date().getFullYear()} Explora AI. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
